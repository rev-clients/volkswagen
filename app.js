...
function animacionHoverImagenEnter() {
  if (!!$(this).parents(".grid").length)
    $(this).parents(".grid").addClass("titulo-hover");
  if (!!$(this).parents(".block-img").length)
    $(this).parents(".block-img").addClass("titulo-hover");
}

function animacionHoverImagenLeave() {
  if (!!$(this).parents(".grid").length)
    $(this).parents(".grid").removeClass("titulo-hover");
  if (!!$(this).parents(".block-img").length)
...
function carousel() {
  ...
  function nextSlide() {
    ...
    if (currentSlide === $slides.length - 1) {
      ...
      moviment =
        "translate3d(-" +
        (positions[currentSlide].positionLeft - 31) +
        "px, 0px, 0px)";
    }
  ...
  function prevSlide() {
    ...
    moviment =
      "translate3d(-" +
      (positions[currentSlide].positionLeft - 30) +
      "px, 0px, 0px)";
